...
print("Running harmony on unharmonized data")
run_harmony_integration(combined_unharm,batch_key='batch')
print("done")

combined_unharm.write("combined_unharm_sampled.h5ad")

print("Running harmony on scETM data")
run_harmony_integration(combined_unharm_scetm,batch_key='batch')
print("done")

combined_unharm_scetm.write("combined_unharm_scetm_sampled.h5ad")
print("done")

print("plotting the umap for unharmonized data with harmony")
run_and_plot_umap(combined_unharm, "X_pca_harmony", ["cell_type_level1", "batch"],title_prefix="unharmonized_harmony")
print("done")

print("plotting the umap for scETM data with harmony")
run_and_plot_umap(combined_unharm_scetm, "X_pca_harmony", ["cell_type_level1", "batch"],title_prefix="unharmonized_scetm_harmony")
print("done")
